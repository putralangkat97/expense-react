import{c as n}from"./createLucideIcon-oJZHkGgr.js";import{j as e,r as l}from"./app-CFT4YXQV.js";class x{formatDate(s){const[a,c,t]=s.split("/");return`${t}-${c}-${a}`}formatCurrency(s){return parseInt(s).toLocaleString("id-ID",{style:"currency",currency:"IDR"})}}/**
